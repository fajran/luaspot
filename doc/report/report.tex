...
sensor node and this is difficult to be done. We provide a solution to make
the sensor network scriptable that is also allows us to dynamically install
new applications through the network. We will also show that our solution
