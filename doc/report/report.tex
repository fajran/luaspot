...
handle this kind of things. This application is written in Java and will be
...
\begin{figure}[htbp]
	...
	\scalebox{0.8} % Change this value to rescale the drawing.
	{
	\begin{pspicture}(0,-0.9)(9.82,0.92)
	\psframe[linewidth=0.04,dimen=outer,fillstyle=solid](9.8,0.9)(0.0,-0.9)
	\usefont{T1}{pcr}{m}{n}
	\rput(0.38,0.495){c}
	\rput(1.9,0.495){manager}
	\rput(3.98,0.495){install}
	\rput(5.7,0.495){name}
	\rput(7.1,0.495){index}
	\rput(8.7,0.495){fragments}
	\rput(4.9,-0.385){application data}
	\psline[linewidth=0.04cm](0.0,0.1)(9.8,0.1)
